...
export const MacbookScroll = ({
  ...
  return (
    <div
      ref={ref}
      className="min-h-[100vh]  flex flex-col items-center py-0 md:py-10 justify-start flex-shrink-0 [perspective:800px] transform md:scale-100  scale-[0.75] sm:scale-100"
    >
      <motion.h2
        style={{
        ...
        className="dark:text-white text-neutral-800 text-3xl font-normal mb-20 text-center"
      >
        {title || (
          <span>
            Do you know? <br /> Cyber Attacks Increased by 30% in 2024.
          </span>
        )}
      </motion.h2>
      {/* Lid */}
    ...
    <div className="relative [perspective:800px]">
      ...
      >
        ...
        <img
          ...
          className="object-cover object-left-top absolute rounded-none inset-0 h-full w-full"
        />
      </motion.div>
    </div>
  );
