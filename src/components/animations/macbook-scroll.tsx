...
export const MacbookScroll = ({
  ...
  return (
    <div
      ref={ref}
      className="min-h-[50vh]  flex flex-col items-center py-0 md:py-10 justify-start flex-shrink-0 [perspective:800px] transform md:scale-100  scale-[0.75] sm:scale-100"
    >
      <motion.h2
        style={{
